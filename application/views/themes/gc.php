...
<head>
	...
	<link href="<?php echo base_url(); ?>assets/css-custom/css-master-data.css" rel="stylesheet" type="text/css" />
	<link rel="stylesheet"  href="<?php echo base_url();?>assets/theme_admin/css/table.css" type="text/css"/>
	...
	<!--[if lt IE 9]>
	 ...
	 <script type="text/javascript">
	 	$(document).ready(function(){
	 		$('div#quickSearchBox .crud_search,div#quickSearchBox .search_clear').addClass('btn btn-sm btn-default');
	 		$('.tDiv .fbutton').addClass('btn btn-xs btn-default');
	 	});
	 </script>
</head>
